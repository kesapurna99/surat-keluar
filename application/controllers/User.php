...
class User extends CI_Controller {
  ...
  //-------------Controller pegawai-------------//
	public function Datauser()
	{
		...
		$this->load->view("User/data_user.php", $data);
	}
	...
	public function Setting()
	{
		...
		$this->load->view("User/view_setting.php", $data);
	}
	...
	{  
        ...
        $this->load->view("User/input_datauser.php");
	}
	public function edituser($id = null)
    {
        if (!isset($id)) redirect('User/Datauser');
        ...
        $this->load->view("User/edit_datauser", $data);
    }
...
function tambahkendalisurat()
	{
        ...
        $validation->set_rules($kendali->rules());
            ...
            $this->load->view('User/input_kendalisurat',$data);
	}

	function datakendalisurat()
	{
	$data["Kendali"] = $this->MKendaliSurat->getAll();
		$this->load->view("User/data_kendalisurat.php", $data);
	}
	public function deletekendali($id=null)
    {
        ...
        if ($this->MKendaliSurat->delete($id)) {
            redirect(site_url('User/datakendalisurat'));
        }
	}
    function tambah_surat_keluar()
	{
	$data["Kendali"] = $this->MKendaliSurat->getAll();
		$this->load->view("User/tambah_surat_keluar.php", $data);
	}
	...
	public function upload_data()
    {
        ...
        $validation->set_rules($kendali->rules_upload());
		   ...
		   if(! $this->upload->do_upload('file')){
                ...
                redirect("User/datakendalisurat");
			}else{
                $kendali->upload_data();
			$this->session->set_flashdata('success', 'Berhasil disimpan');
			redirect("User/datakendalisurat");
