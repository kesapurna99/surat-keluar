        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
             ...
             <div class="col-md-5">
              <a href="<?php echo site_url('User/tambahkendalisurat'); ?>" class="btn btn-primary"  type="button">Tambah <i class="ri-add-circle-line"></i></a>
              </div>
                <div class="col-md-3 ">
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="<?php echo site_url('User/upload_data') ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
